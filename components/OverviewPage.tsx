...
import { BookOpen, Scale, FileText, GraduationCap, AlertOctagon, ChevronDown, ChevronUp } from 'lucide-react';
...
const OverviewPage: React.FC = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p className="text-[11.5px] text-slate-400 font-medium">법 제31조의2, 제31조의3, 고시 제65조</p>
          {[
            ...
            <div key={i} className="bg-red-50/50 rounded-2xl p-3.5 border border-red-100/60">
              <p className="text-[12px] font-black text-red-600 mb-1">{item.role}</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p className="text-[11.5px] text-slate-400 font-medium">법 제31조의2 제3항, 제4항</p>
          ...
          <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100">
            <p className="text-[12px] font-bold text-slate-500 mb-1.5">※ 특별안전교육</p>
            <p className="text-[13px] text-slate-600 leading-relaxed font-medium">
  ...
  return (
    <div className="space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="bg-slate-800 py-4 px-5 flex items-center gap-3">
          <BookOpen className="w-5 h-5 text-blue-400" />
          <div>
            <h2 className="text-[16px] font-black text-white">지상안전사고 개요</h2>
            <p className="text-[11px] text-slate-400 mt-0.5">공항시설법 · 공항안전운영기준(고시)</p>
          </div>
        </div>
      </div>
        ...
        <div key={i} className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-[14px] font-black text-slate-800">{sec.title}</span>
            </div>
            {openSection === i
